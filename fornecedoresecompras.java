...
public class fornecedoresecompras {
    ...
    public static void main(String[] args) throws SQLException {
        ...
        conexao.createStatement().executeUpdate("INSERT INTO fornecedores (nome, contato) VALUES ('Fornecedor J', 'Contato A')");
        conexao.createStatement().executeUpdate("INSERT INTO fornecedores (nome, contato) VALUES ('Fornecedor V', 'Contato X')");
